...
public class JwtController {
	...
	public JwtResponsePOJO generateToken(@RequestBody TokenGenerationRequest tokenGenerationRequest) {
		...
		try {
			...
			TokenGenerationPOJO tokenGenerationResponse=jwtService.generateToken(tokenGenerationRequest);
	...
	public JwtResponsePOJO regenerateTokens(@RequestBody RefreshTokenRequest refreshTokenRequest) {
		...
		try {
			...
			TokenGenerationPOJO refreshTokenResponse = jwtService.regenerateTokens(refreshTokenRequest);
			if (StringUtils.hasText(refreshTokenResponse.getAccessToken())
				...
				jwtResponsePOJO.response("Unable to get response", null, false);
			}
		} catch (Exception e) {
